...
from utils import tokenize_prompt_and_outputs, per_token_entropy, get_response_log_probs, masked_normalize, sft_microbatch_train_step
...
def run_tokenize_prompt_and_output(
    ...
    return tokenize_prompt_and_outputs(prompt_strs, output_strs, tokenizer)
